...
for(link in yellow_chrono){
  ...
  short_data$pickup_datetime <- ifelse(str_detect(link, "2009"), short_data$Trip_Pickup_DateTime,
                                ifelse(str_detect(link, "2015"), short_data$tpep_pickup_datetime,
                                ifelse(str_detect(link, "2016"), short_data$tpep_pickup_datetime,
                                       short_data$pickup_datetime)))
  short_data$dropoff_datetime <- ifelse(str_detect(link, "2009"), short_data$Trip_Dropoff_DateTime,
                                ifelse(str_detect(link, "2015"), short_data$tpep_dropoff_datetime,
                                ifelse(str_detect(link, "2016"), short_data$tpep_dropoff_datetime,
                                       short_data$pickup_datetime)))
  ...
  rm(all_counts); rm(final_counts); rm(temp);
}
