...
pu_heatmap <- pu_map + geom_point(data = pu_june2016, alpha = 0.2, size = 0.3,
...
do_heatmap <- do_map + geom_point(data = do_june2016, alpha = 0.2, size = 0.3,
...
ovr_densitymap <- do_map + geom_point(data = do_june2016, alpha = 0.05, size = 0.1,
                                  aes(x = dropoff_longitude, y = dropoff_latitude)) +
